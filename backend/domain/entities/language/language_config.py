"""Language configuration entity — populated from backend/languages/*.yml at startup."""
...
@dataclass(frozen=True)
class TestConfig:
    __test__ = False  # pytest: not a test class (name matches Test* pattern)
...
class LanguageConfig:
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "supported_features": [f.value for f in self.supported_features],
        }
