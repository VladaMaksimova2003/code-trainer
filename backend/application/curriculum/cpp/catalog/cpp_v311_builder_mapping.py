...
TASK_FORMAT_TO_BUILDER: dict[str, str] = {
    "перевод_программы": "translation_to_cpp",
    "перевод_фрагмента": "translation_snippet_to_cpp",
    "исправление": "cpp_debug_starter",
    "поиск_ошибки": "cpp_debug_starter",
    "сборка_программы": "block_reorder_cpp",
    "сборка_фрагмента": "block_reorder_cpp",
    "код_по_блок-схеме": "flowchart_cpp",
    "блок-схема_по_коду": "flowchart_cpp",
    "выбор_фрагмента": "mcq_cpp_fragment",
}
