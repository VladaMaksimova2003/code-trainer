...
from application.curriculum.cpp.showcase.cpp_v311_registry import v311_collection_by_key, v311_title_prefix
...
def order_collection_showcase_tasks(
    ...
    rows = list_cpp_tasks_for_collection(session, chapter_key)
...
def build_cpp_v311_showcase_collection_next(
    session: Session,
    chapter_key: str,
    user_id: int | None,
) -> dict[str, Any]:
