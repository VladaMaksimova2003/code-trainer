"""task_format → builder mapping for Pascal Course v3.1.1."""
from __future__ import annotations

from shared.enums import AssignmentType

TASK_FORMAT_TO_BUILDER: dict[str, str] = {
    "перевод_программы": "translation_to_pascal",
    "перевод_фрагмента": "translation_snippet_to_pascal",
    "исправление": "pascal_debug_starter",
    "поиск_ошибки": "pascal_debug_starter",
    "сборка_программы": "block_reorder_pascal",
    "сборка_фрагмента": "block_reorder_pascal",
    "код_по_блок-схеме": "flowchart_pascal",
    "блок-схема_по_коду": "flowchart_pascal",
    "выбор_фрагмента": "mcq_pascal_fragment",
}
