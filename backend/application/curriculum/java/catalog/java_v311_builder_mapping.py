"""task_format → builder mapping for Java Course v1."""
from __future__ import annotations

from shared.enums import AssignmentType

TASK_FORMAT_TO_BUILDER: dict[str, str] = {
    "перевод_программы": "translation_to_java",
    "перевод_фрагмента": "translation_snippet_to_java",
    "исправление": "java_debug_starter",
    "поиск_ошибки": "java_debug_starter",
    "сборка_программы": "block_reorder_java",
    "сборка_фрагмента": "block_reorder_java",
    "код_по_блок-схеме": "flowchart_java",
    "блок-схема_по_коду": "flowchart_java",
    "выбор_фрагмента": "mcq_java_fragment",
}
