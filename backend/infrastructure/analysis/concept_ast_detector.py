...
from infrastructure.analysis.tree_sitter_gateway import _CompatNode as Node, _CompatTree as Tree

from domain.analysis.core_detection import CoreDetectionResult
from domain.learning.skill_groups import CONCEPT_IDS
from infrastructure.analysis.concept_registry import get_concept, load_concepts
