#!/usr/bin/env python3
"""Import 8 loops chapter tasks (17-24) directly into PostgreSQL."""
...
from scripts.loops_ch3_user_payload import CHAPTER_KEY, TASKS


def main() -> int:
    parser = argparse.ArgumentParser(description="Import loops chapter tasks 17-24 into PostgreSQL")
