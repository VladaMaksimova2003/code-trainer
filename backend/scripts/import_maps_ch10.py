#!/usr/bin/env python3
"""Import 8 maps chapter tasks (73-80) directly into PostgreSQL."""
...
from scripts.maps_ch10_user_payload import CHAPTER_KEY, TASKS


def main() -> int:
    parser = argparse.ArgumentParser(description="Import maps chapter tasks 73-80 into PostgreSQL")
