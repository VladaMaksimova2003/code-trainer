#!/usr/bin/env python3
"""Import 8 linked_lists chapter tasks (97-104) directly into PostgreSQL."""
...
from scripts.linked_lists_ch13_user_payload import CHAPTER_KEY, TASKS


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Import linked_lists chapter tasks 97-104 into PostgreSQL"
    )
