#!/usr/bin/env python3
"""Import 8 inheritance_capstone chapter tasks (121-128) into PostgreSQL."""
...
from scripts.inheritance_ch16_user_payload import CHAPTER_KEY, TASKS


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Import inheritance_capstone chapter tasks 121-128 into PostgreSQL"
    )
