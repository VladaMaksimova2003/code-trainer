...
Run full course (270 tasks, 26 chapters):
  poetry run python scripts/seed_csharp_course_v311.py --stage all
...
from application.curriculum.csharp.showcase.csharp_v311_showcase_all_specs import specs_for_chapters
