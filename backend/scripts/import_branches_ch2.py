#!/usr/bin/env python3
"""Import 8 branches chapter tasks (9-16) directly into PostgreSQL."""
...
from scripts.branches_ch2_user_payload import CHAPTER_KEY, TASKS
from scripts.curriculum_user_import import import_user_chapter


def main() -> int:
    parser = argparse.ArgumentParser(description="Import branches chapter tasks 9-16 into PostgreSQL")
