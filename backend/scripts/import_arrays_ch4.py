#!/usr/bin/env python3
"""Import 8 arrays_collections chapter tasks (25-32) directly into PostgreSQL."""
...
from scripts.arrays_ch4_user_payload import CHAPTER_KEY, TASKS
from scripts.curriculum_user_import import import_user_chapter


def main() -> int:
    parser = argparse.ArgumentParser(description="Import arrays chapter tasks 25-32 into PostgreSQL")
