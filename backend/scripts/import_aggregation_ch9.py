#!/usr/bin/env python3
"""Import 8 aggregation chapter tasks (65-72) directly into PostgreSQL."""
...
from scripts.aggregation_ch9_user_payload import CHAPTER_KEY, TASKS
from scripts.curriculum_user_import import import_user_chapter


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Import aggregation chapter tasks 65-72 into PostgreSQL"
    )
