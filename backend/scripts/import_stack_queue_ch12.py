#!/usr/bin/env python3
"""Import 8 stack_queue chapter tasks (89-96) directly into PostgreSQL."""
...
from scripts.stack_queue_ch12_user_payload import CHAPTER_KEY, TASKS


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Import stack_queue chapter tasks 89-96 into PostgreSQL"
    )
