#!/usr/bin/env python3
"""Import 8 functions chapter tasks (41-48) directly into PostgreSQL."""
...
from scripts.functions_ch6_user_payload import CHAPTER_KEY, TASKS


def main() -> int:
    parser = argparse.ArgumentParser(description="Import functions chapter tasks 41-48 into PostgreSQL")
