#!/usr/bin/env python3
"""Import 8 files_modules chapter tasks (81-88) directly into PostgreSQL."""
...
from scripts.files_modules_ch11_user_payload import CHAPTER_KEY, TASKS


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Import files_modules chapter tasks 81-88 into PostgreSQL"
    )
