#!/usr/bin/env python3
"""Import 8 oop chapter tasks (113-120) directly into PostgreSQL."""
...
from scripts.oop_ch15_user_payload import CHAPTER_KEY, TASKS


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Import oop chapter tasks 113-120 into PostgreSQL"
    )
