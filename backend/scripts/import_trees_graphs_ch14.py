#!/usr/bin/env python3
"""Import 8 trees_graphs chapter tasks (105-112) directly into PostgreSQL."""
...
from scripts.trees_graphs_ch14_user_payload import CHAPTER_KEY, TASKS


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Import trees_graphs chapter tasks 105-112 into PostgreSQL"
    )
