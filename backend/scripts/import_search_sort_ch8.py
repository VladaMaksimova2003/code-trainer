#!/usr/bin/env python3
"""Import 8 search/sort chapter tasks (57-64) directly into PostgreSQL."""
...
from scripts.search_sort_ch8_user_payload import CHAPTER_KEY, TASKS


def main() -> int:
    parser = argparse.ArgumentParser(description="Import search_sort chapter tasks 57-64 into PostgreSQL")
