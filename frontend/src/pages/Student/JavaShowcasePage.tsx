...
const LANGUAGE = "java"
const HUB_PATH = "/learn/java"

interface JavaShowcasePageProps {
  user?: { id?: number | string } | null
  onSignOut?: () => void
}

export default function JavaShowcasePage({ user, onSignOut }: JavaShowcasePageProps) {
  ...
  const description =
    ...
    (typeof data?.learning_concept === "object" && data?.learning_concept
      ...
      : "Задачи по Java: перевод, отладка и сборка фрагментов в синтаксисе Java.")
              ...
              <div className="mb-1 flex flex-wrap items-end justify-between gap-4">
                <div className="min-w-0">
                  ...
                  <h1 className="m-0 mb-1 text-[26px] font-extrabold tracking-[-0.6px] text-ink">
                    <span className="text-[18px] font-semibold text-ink-faint">Java / </span>
                    {title}
                  </h1>
