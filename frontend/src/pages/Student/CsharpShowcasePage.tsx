...
const HUB_PATH = "/learn/csharp"

interface CsharpShowcasePageProps {
  user?: { id?: number | string } | null
  onSignOut?: () => void
}

export default function CsharpShowcasePage({ user, onSignOut }: CsharpShowcasePageProps) {
  ...
  const description =
    ...
    (typeof data?.learning_concept === "object" && data?.learning_concept
      ...
      : "Задачи по C#: перевод, отладка и сборка фрагментов в синтаксисе C#.")
              ...
              <div className="mb-1 flex flex-wrap items-end justify-between gap-4">
                <div className="min-w-0">
                  ...
                  <h1 className="m-0 mb-1 text-[26px] font-extrabold tracking-[-0.6px] text-ink">
                    <span className="text-[18px] font-semibold text-ink-faint">C# / </span>
                    {title}
                  </h1>
